          ...
          <AnimatePresence mode="wait">
            {isCompleted ? (
              ...
              <motion.div
                ...
                className="flex-1 flex flex-col items-center justify-center text-center space-y-6 bg-red-950/20 border border-red-500/20 rounded-2xl"
              >
                ...
                <div className="space-y-1">
                  ...
                  <h2 className="text-5xl font-black text-white font-heading tracking-tight uppercase px-6 py-3 bg-gradient-to-r from-red-600/30 to-red-800/30 border border-red-500/30 rounded-2xl shadow-[0_0_30px_rgba(239,68,68,0.25)] animate-pulse">
                    {lastBuzzerName}
                  </h2>
              ...
              <motion.div
                ...
                animate="show"
                exit="exit"
                className="flex-1 flex flex-col justify-between space-y-6 text-center"
              >
              ...
              >
                ...
                {state.activeQuestion.options.length > 0 && (
                  <motion.div
                    ...
                    animate="show"
                    key={state.activeQuestion.id}
                    className="grid gap-3 sm:grid-cols-2 pt-6"
                  >
                    {state.activeQuestion.options.map((opt, idx) => {
                      const prefix = String.fromCharCode(65 + idx);
          ...
          >
            <div className="text-center space-y-4">
              ...
              <motion.div
                ...
                className="text-9xl font-black font-heading text-white"
              >
                {buzzerCountdown}
              </motion.div>
